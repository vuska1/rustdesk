...
{sleep}
    ",
        ...
        // claude: rename_exe_cmd fehlt im install-Pfad (im update-Pfad war es schon drin).
        // rustdesk.exe (Cargo-Binärname) wird nach {app_name}.exe umbenannt damit
        // Shortcuts, UninstallString und Registry auf den richtigen Dateinamen zeigen.
